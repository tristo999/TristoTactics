...
An external entity that arrived centuries ago to take what the Guardian
protects. It absorbed the world's many kingdoms into a single empire — by pacts
...
**[open]** Whether "the Authority" is a singular entity or the empire itself,
and its leadership above Commander Vael. Note: the finale now answers part of
this — see *The true form*, below.

### The Kingdom [settled] / **[open]** name

The last free country. The only realm the Authority never took, held for
centuries behind the Guardian's power, no contact with the outside in living
memory. The outside world mythologizes it as a nest of thieves who stole
something long ago. It is exhausted and losing as its barrier fails. **[open]**
its name and cultural identity.

### The "stolen divine" [settled]

The propaganda says the free country stole something long ago. The truth: the
"something" is the divine itself. Having replaced every other god with itself,
the Authority brands the one kingdom that still holds the real god as thieves.
They didn't steal anything — they're the last place the true god was never
stolen *from*. This is the whole thesis compressed into a single piece of
propaganda. Keep it.


## THE GUARDIAN AND THE CORE (revised 2026-05)

### The Guardian [settled]

**Not the source of all magic.** Magic exists in the world independently. The
...
**The Guardian was never captured.** The old docs said the Authority seized it
mid-summoning. It did not. The Guardian still stands in the capital, still
guarding the core, still holding out against the Authority's power as it always
has. What the Authority did at the summoning was **intercept the connection**:
it got between the Guardian and the hero, jammed the signal, and walled the
hero's mind with the lie. The Guardian is not a prisoner sending postcards from
a cell. It is alive, on its feet, fighting — and *cut off* from the champion it
called.

### Why the core matters [settled]

The core is what the Authority has wanted for centuries, and the reason this is
a war and not an execution. Taking it does two things at once (see *The true
form* and *The legion*). It is an object the Authority can take — which is what
makes it a real endgame and not an abstraction.

**[open]** The exact metaphysics of the core (e.g. is it what lets magic
*renew*, the only renewable spring while everything else spends down? a working
hypothesis, not locked). Lock this only as far as the story needs.

### The glitches [settled]

Throughout Act 1 the Guardian pushes contact through the Authority's jam in
fragments — glitched, incomplete, escalating as the empire's line closes on the
capital and the jam gets harder to maintain. This is the Guardian *straining
across the jam*, actively reaching — not bleeding out passively. A half
sentence. A wrong color. A moment where the world's edge doesn't look right.

Vael explains them away as "artifact interference" — receptive minds picking up
bleed from a dangerous weapon. The hero has no basis to contradict this. **The
glitches never complete a full sentence until the hero is physically close
enough to the Guardian at the capital** (see Act 1 ending). They are the only
honest voice in Act 1.


## THE HERO [settled]

Silent protagonist, no backstory, player-named. Summoned by the Guardian just
before the war's climax, arrives with no memory of the descent or the voice —
only the feeling that a voice called them and asked them to find it. The
Authority's lie reframes this immediately: the kingdom uses a corrupted artifact
to pull soldiers from other worlds; the voice was the artifact luring them. The
hero fights Act 1 believing the voice belongs to a prisoner to rescue or a
weapon to stop. Either way, a reason to move forward.

The hero's ignorance is *structural* — with no memory of the descent, they have
nothing to contradict Vael with. The brainwashing was an act of arrogance:
turning the Guardian's own champion against it as an insult to its resistance.
...
The campaign the hero fights believing the lie. The through-line, revised: **the
hero is the weapon the Authority marches toward the one door it could never
open.** Every "liberation" is a step toward the capital. The hero is delivering
the empire to the Guardian's threshold, certain it's righteous, the whole time
moving toward the voice without knowing it.

Authored *backward from the collisions* (see ledger). Act 1's job is to be a
minefield of unmarked ordnance — the boss you beat, the bridge you cursed, the
figures you dismissed, the glitch you ignored — that Act 2 detonates. Get the
player to spend real emotions (triumph, contempt, annoyance, dismissal) cheaply
and sincerely on things Act 2 will itemize and return with interest. None of it
flagged.

Beats to hit, in order (loose — not the old locked list): arrival in the wrong
place (the summoning chamber, Vael's warm "you actually made it"); training and
the first companions; the campaign against "insurgents" who are the kingdom's
defenders; first dismissed anomalies; the shadowed figures the Authority calls
saboteurs (they're the Act 2 party); the companion choice; and the march
...
a champion who realizes too late that they delivered their own god to slaughter
is the more complete victory. So the Guardian's first clear words land in the
exact instant the hero understands they are the reason the Guardian is about to
...
- **The true form.** It stops wearing dead gods and simply *is.* The final boss
  ...
  before the end; the monster wearing the Guardian's stolen role is the
  replacement.)
- **The legion.** Taking the core opens a door, and an **endless legion** comes
  through with the manifestation — a host that will sweep the planet.

**In Act 1, the hero opens that door.** The apocalypse comes through because of
what the hero did believing they were good. That is the thing celebrated in Act
1 and lived with in Act 2.


## ACT 2 — THE FRACTURED BLADE

The surviving party is thrown back to before Act 1. The loop holds: Act 1 is
inevitable, the door opens regardless. The party lived the ending, so they know
...
three fronts at the end. Gathering salvation *is* assembling the final-battle
cast. Every region you can still reach is one you may not reach next week, and
because the kingdom loses, every place you visit you're seeing alive that you'll
see dead — or already saw burn. The clock isn't just "hurry," it's "say goodbye
to everywhere you go."

The point of Act 2 is **not** to prevent Act 1. It's to be *ready on the other
side of the door this time.* The first time the door opened onto a world that
didn't know it was coming. The second time it opens onto you, waiting, with
everything you could carry there.

Act 2 is *mostly its own campaign* — its own objectives, its own crew, real
breathing room. The collisions are peaks, not texture. They happen where an Act
2 objective and Act 1 history want the same ground. The map remembers what
mattered.
...
- **The flanks: an unwinnable vigil.** The Guardian's last soldiers and the
  Authority's *old army* — two sides lied into hating each other for a war —
  unite and stand together against the endless legion. The reconciliation is
  shown as a **formation, not a speech**: the two banners in one line *is* the
...
is no longer saving everyone. Grace is **being worthy of the sacrifice** —
reaching the door before the line they're holding runs out, so the time they
bought with their lives doesn't go to nothing. The hardest expression of the
thesis: sometimes the most merciful thing you can do with a sacrifice is be
worth it.
...
1. What the fragment does at the core/door — the keystone.
