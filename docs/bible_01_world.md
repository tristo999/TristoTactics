# TristoTactics — Story Bible (Standalone Draft)

> **What this is.** A single, standalone narrative bible — the whole story, told
> like the outline of a novel. Anyone could read it cold and see the game's
> story start to finish. It folds in everything currently settled across the
> design docs, and fills the remaining gaps with proposals.
>
...
The empire looks, from inside, like it has classes — the comfortable and the
wretched. It does not. What it has is a **gradient of how early you gave in.**
...
ancestors flinched first. **Prosperity is a confession. Poverty is a scar.**

There is no clean tier to root for. The comfortable aren't villains — their
grandparents just took the obvious deal, and who wouldn't? The downtrodden aren't
...
something* long ago and have been hiding it ever since.
